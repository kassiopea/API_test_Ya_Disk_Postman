...
### Проверки
**<a name="main_tests"></a> Основные** на загрузку файла
...
**<a name="additional"></a> Дополнительные** на загрузку файла
...
**<a name="upload"></a> Загрузка тестовых данных** на Я.Диск осуществляется с помощью запроса на получение ссылки (к названию файла добавляется рандомное число от 1 до 13) и загрузки одного и того же файла, размером 2GB. Загрузка осуществляется до тех пор, пока свободное пространство на диске будет меньше или равно указанному в переменной "necessarySpace". В данном случае necessarySpace = 2147483648 байт.
