...
-- "linkPath" содержит путь к файлу на ЯДиске с указанием названия файла, который будет загружен. Может быть как относительный, так и абсолютный. По документации необходимо использовать путь в формате url.
